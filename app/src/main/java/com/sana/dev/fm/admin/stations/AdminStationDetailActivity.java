...
/** تفاصيل الإذاعة */
public class AdminStationDetailActivity extends BaseActivity {
    private static final String EXTRA_ID = "station_id";

    public static void startActivity(Context ctx, String id) {
        Intent i = new Intent(ctx, AdminStationDetailActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (toolbar != null) {
            toolbar.setTitle(R.string.label_station_details);
            toolbar.setNavigationOnClickListener(v -> finish());
        }

        TextView tvTitle = findViewById(R.id.tv_title);
        if (tvTitle != null) {
            tvTitle.setText(R.string.label_station_details);
        }
    }
}
