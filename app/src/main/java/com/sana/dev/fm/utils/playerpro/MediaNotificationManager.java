...
//import com.sana.dev.fm.utils.radio_player.RadioService;
...
//
//
//    public void startNotify(Bitmap notifyIcon) {
...
//        Intent playbackAction = new Intent(service, RadioPlayerService.class);
//        playbackAction.setAction(RadioPlayerService.ACTION_PAUSE);
...
//        }
//
//        Intent stopIntent = new Intent(service, RadioPlayerService.class);
//        stopIntent.setAction(RadioPlayerService.ACTION_STOP);
