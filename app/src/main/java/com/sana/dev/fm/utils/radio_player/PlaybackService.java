...
import com.sana.dev.fm.utils.radio_player.media.MediaSessionWrapper;
    ...
    private void resume() {
        if (mIsPaused) {
            ...
            if (mAudioManager.requestAudioFocus(this, AudioManager.STREAM_MUSIC, AudioManager.AUDIOFOCUS_GAIN)
                ...
                intent.putExtra(PlaybackListener.EXTRA_KEY_TRACK, mPlayerPlaylist.getCurrentTrack());
                mLocalBroadcastManager.sendBroadcast(intent);
...
//        mNotificationManager.notify(this, mPlayerPlaylist.getCurrentTrack(), mIsPaused);
    }
