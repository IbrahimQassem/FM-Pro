...
| التفاعل | تعليقات، إعجاب حلقة، مشاركة؛ المفضلة والاشتراك غير مكتملين | عرض تعليقات الحلقة لحظيًا وإضافتها للمستخدم المسجل | اعتماد التعليقات؛ بقية التفاعل يحتاج قرارًا |
| الحساب | ضيف، Google، Facebook، هاتف، ملف شخصي، حذف الحساب | ضيف وEmail/password وإنشاء/استعادة/خروج | اعتماد المسار الحالي؛ الملف المتقدم والحذف والمزودون مؤجلون |
| الإدارة | لوحة وإحصاءات وقوائم وحذف/تعطيل؛ نماذج كثيرة placeholders | غير موجود | يفضل منتج إدارة منفصل؛ تحقق أولاً |
| الإشعارات | FCM، إذن Android، حفظ token، إشعار بسيط | اشتراك FCM اختياري لإعلانات ثابتة وقائمة جلسة؛ بلا حفظ token | اعتماد الإعلانات ثم إضافة inbox خادمي فقط عند الحاجة |
