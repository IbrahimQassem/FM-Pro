...
| البث المباشر | تشغيل/إيقاف مؤقت/إيقاف، mini-player، إشعار foreground، metadata | تشغيل `just_audio` وmini-player موجودان | استكمال الخلفية والإشعار والجلسة الصوتية |
