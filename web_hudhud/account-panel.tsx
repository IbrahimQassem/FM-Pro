...
export function AccountPanel({ stations, selectedStationId, createRepository = () => new AccountRepository() }: { stations: Station[]; selectedStationId: string | null; createRepository?: () => AccountPort }) {
  ...
  return <section className="content-section account-panel" id="account" aria-labelledby="account-title"><h2 id="account-title" tabIndex={-1}>حسابي ومحطاتي</h2><p>الاستماع متاح للجميع. المتابعة تحفظ المحطة في حسابك، والتنبيهات اختيار منفصل.</p>
