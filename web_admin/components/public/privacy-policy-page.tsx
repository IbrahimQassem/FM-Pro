        ...
        <Card>
          ...
          <CardContent className="space-y-3 leading-7 text-sm sm:text-base">
            <ul className="list-disc space-y-2 ps-6">
              ...
              <li>
                <strong>أداء الرعايات والإعلانات:</strong> نحسب مرات ظهور الإعلان والنقر عليه بحسب الحملة واليوم والمنصة، دون ربطها بحسابك أو بمعرّف إعلاني أو جهاز دائم. نستخدم معرّف عرض عشوائي قصير العمر لمنع العد المكرر؛ تنتهي صلاحيته خلال دقيقة، وتصبح سجلاته مؤهلة للحذف بعد يوم عبر تنظيف دوري. تبقى التقارير اليومية مجمّعة ولا تحدد أشخاصًا. قد يستقبل مزود صورة الإعلان معلومات اتصال الشبكة اللازمة لتحميل الصورة؛ وفتح موقع المعلن ينقلك إلى موقع مستقل يخضع لسياسة خصوصيته.
              </li>
            </ul>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="space-y-3 leading-7 text-sm sm:text-base">
            <ul className="list-disc space-y-2 ps-6">
              ...
              <li>
                <strong>معرض الصور والكاميرا (اختياري):</strong> لتمكينك من اختيار أو التقاط صورة لملفك الشخصي فقط. نعيد ترميز الصورة لإزالة بياناتها الوصفية ونخزن نسخة مصغرة؛ يمكن لمن يملك رابط عرض الصورة مشاهدتها. نحذف الصورة السابقة عند استبدالها.
              </li>
            </ul>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="space-y-3 leading-7 text-sm sm:text-base">
            ...
            <p className="mt-2 text-muted-foreground text-xs sm:text-sm">
              تحذف عملية الحذف بيانات الحساب والتعليقات والمفضلات من بيئتي التطبيق المرتبطتين بالحساب. تبقى علامة أمان مؤقتة مرتبطة بمعرّف الحساب، لا تحتوي الاسم أو البريد أو المحتوى، لمنع إعادة البيانات برمز دخول قديم. تنتهي بعد 24 ساعة وتزال في دورة التنظيف اليومية التالية؛ نتابع أي تأخر ناتج عن عطل في التنظيف. تزال صور الحساب من البيئتين، وتبقى سجلات تنظيف خاصة لمدة ساعة على الأقل لمعالجة أي رفع متزامن؛ تحذفها دورة التنظيف الناجحة التالية مع أي ملفات متأخرة.
            </p>
          </CardContent>
        </Card>
